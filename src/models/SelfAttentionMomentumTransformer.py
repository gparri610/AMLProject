...
from models import LSTMEncoder, GRN, GLU_custom

class SelfAttentionMomentumTransformer(nn.Module):
    """
    This is a variation of main model developed in our reference paper.
    Instead of the Interpretable Mulithead Attention we use regual Multihead Self Attention.
